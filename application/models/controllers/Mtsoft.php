...
$isInsert = $this->agenceManager->ajouter_agence($nom_agence,$login_agence,$mdp_agence, $contact_agence, $email_agence,$adresse_agence,$siege_agence,$photoNom, $etat );
