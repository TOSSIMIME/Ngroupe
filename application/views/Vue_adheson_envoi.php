...
<link rel="stylesheet" type="text/css" media="all" href="<?php echo css_url('horloge'); ?>" />
 ...
 <center>
  ...
  <p>Votre demande d'adhesion est en cours de traitement.</p>
  <hr>
  <p class="mb-0">Vous allez recevoir un code telephonique sur votre numero: <strong><a href="">+226 <?php echo $this->session->flashdata('phone');?></a></strong> ou par <br>Votre email cliquez ici : <a href="https://www.google.com/intl/fr/gmail/about/" target="_blank"><?php echo $this->session->flashdata('message');?></p>
</div>
